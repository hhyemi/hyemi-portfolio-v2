...
import {
  Box, BoxProps, Flex, Image, ImageProps, StyledLink, Text, TextProps,
  ...
  return (
    <LayoutMain>
      <Box>
        ...
        <ImageHeader src={"/images/qmit-main.avif"}/>
            ...
            <ContentBox>
              ...
              <Flex>
                <Box>
                  ...
                  <ContentText>{"   • issue tracking에 올라온 task들을 우선순위(priority)에 따라 처리 "}</ContentText>
                </Box>
              </Flex>
            </ContentBox>
